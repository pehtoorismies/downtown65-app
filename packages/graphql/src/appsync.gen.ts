...
export type SignupMutation = {
  ...
  signup: {
    ...
    user?:
      ...
      | undefined
    errors?:
      | Array<{ __typename?: 'FieldError'; path: SignupField; message: string }>
      | undefined
  }
}
...
export type BaseFieldsFragment = {
  __typename?: 'Event'
  id: string
  dateStart: any
...
export type ParticipateEventMutation = {
  __typename?: 'Mutation'
  participateEvent?: boolean | undefined
}
...
export type DeleteEventMutation = {
  __typename?: 'Mutation'
  deleteEvent?: { __typename?: 'IDPayload'; id: string } | undefined
}
...
export function getSdk(
  ...
  return {
    ...
    GetEvent(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetEventQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEventQuery>(GetEventDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetEvent',
    ...
    ParticipateEvent(
      variables: ParticipateEventMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ParticipateEventMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ParticipateEventMutation>(
    ...
    LeaveEvent(
      variables: LeaveEventMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<LeaveEventMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<LeaveEventMutation>(LeaveEventDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'LeaveEvent',
    ...
    UpdateEvent(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateEventMutation>(UpdateEventDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'UpdateEvent',
    ...
    GetUserByNick(
      variables: GetUserByNickQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetUserByNickQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserByNickQuery>(GetUserByNickDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetUserByNick',
    ...
    UpdateAvatar(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateAvatarMutation>(
